...
class SlidersDemo extends StatelessWidget {
  const SlidersDemo({Key key, }) : super(key: key);
        ...
        children: [
          Column(
            ...
            children: [
              ...
              Text('Continuous with editable numerical value'),
            ],
          ),
        ...
        children: [
          Column(
            ...
            children: [
              ...
              Text('Discrete slider with custom theme'),
            ],
          ),
          const SizedBox(height: 80),
          Column(
            ...
            children: [
              ...
              Text('Continuous range slider with custom theme'),
            ],
          ),
        ],
      ),
