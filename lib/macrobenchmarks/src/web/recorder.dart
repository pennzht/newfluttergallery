...
abstract class SceneBuilderRecorder extends Recorder {
  ...
  Future<Profile> run() {
    ...
    window.onDrawFrame = () {
      print('Recording drawFrameDuration #1 - SceneBuilderRecorder');
...
abstract class WidgetRecorder extends Recorder
  ...
  @mustCallSuper
  void frameDidDraw() {
    print('Recording drawFrameDuration #2 - WidgetRecorder');
...
abstract class WidgetBuildRecorder extends Recorder
  ...
  void frameDidDraw() {
    ...
    if (showWidget) {
      print('Recording drawFrameDuration #3 - WidgetBuildRecorder');
      profile.addDataPoint('drawFrameDuration', _drawFrameStopwatch.elapsed);
    }
...
class Timeseries {
  ...
  List<num> get allValues => _allValues;

  List<num> get measuredValues => _measuredValues;
